; ==================================================================
; The Nebukin Petr Operating System bootloader
; It scans the FAT12 floppy for KERNEL.BIN, loads it and executes it.
...
VolumeLabel		db "NEBUKINPRPT"; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "ZKERNEL SYS"	; Kernel filename
