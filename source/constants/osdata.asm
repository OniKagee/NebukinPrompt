...
%DEFINE OS_NAME_SHORT			'NebukinPrompt'
%DEFINE OS_NAME_LONG			'Nebukin Petr Operating System'
%DEFINE OS_VERSION_NUMBER		'270922'
%DEFINE OS_VERSION_STRING		'OS Build #27-09-2022_21-30'
