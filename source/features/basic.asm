; ==================================================================
; NebukinPrompt -- The Nebukin Petr Operating System
;
; NEBUKINBASIC CODE INTERPRETER (4.4b3)
; ==================================================================
...
dw '***BASINT***'
; ------------------------------------------------------------------
; The NebukinBASIC interpreter execution starts here -- a parameter string
